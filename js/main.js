    ...
    const properties = [
        {
            ...
            badge: 'Featured',
            badgeColor: 'var(--kerala-green-500)',
            type: 'Villa'
        },
        {
            id: 2,
            ...
            badge: 'New',
            badgeColor: 'var(--kerala-blue-500)',
            type: 'Penthouse'
        },
        {
            id: 3,
            ...
            badge: 'Heritage',
            badgeColor: 'var(--kerala-gold-500)',
            type: 'Traditional'
        },
        {
            id: 4,
        ...
        grid.innerHTML = properties.map(property => `
            <div class="property-card">
                ...
                <div class="property-content">
                    ...
                    <button class="btn-primary property-button">View Details</button>
                </div>
            </div>
        `).join('');
    }
...
function loadTestimonials() {
    const testimonials = [
        ...
        },
        {
            ...
            rating: 5,
            text: 'As an NRI investor, I was looking for a trusted partner in Kerala real estate. The team exceeded all expectations with their market knowledge and transparent communication throughout my property acquisition.',
        ...
        },
        {
            ...
            rating: 5,
            text: 'The heritage property they helped us acquire in Kumarakom is absolutely stunning. Their expertise in traditional Kerala architecture and modern amenities created the perfect blend we were seeking.',
        ...
        },
        {
            ...
            rating: 5,
            text: 'Being based overseas, I needed a reliable partner for my Kerala investment. Their digital-first approach and comprehensive market insights made the entire process smooth and trustworthy.',
...
function initInteractiveMap() {
    ...
    const mapElement = document.getElementById('keralaMap');
